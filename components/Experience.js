...
const Experience = () => {
  ...
  const xps = expData.map(items => (
    <div className='border-neutral-800 border-b-[1px] min-w-[200px] p-4 w-full sm:border-none sm:w-[40vw] flex flex-col items-start gap-3 lg:w-[352px] sm:p-5 justify-center shrink-0 transition-all hover:bg-neutral-900/30'>
  ...
  return (
    <div id='experience' className='flex flex-col sm:items-end main'>
