...
const Footer = () => {
  return (
    <div className='main gap-8 footerbg relative flex flex-col items-center justify-center lg:gap-11' style={{background: "linear-gradient(0deg, #121311 0%, #121311 100%), url(./images/footer/background.png), lightgray -0.662px -193px / 100.092% 125.13% no-repeat"}}>
